...
public class StartController {
    ...
    @FXML
    private ComboBox<SchedulingAlgorithm> comboBoxAlgorithm;
    @FXML
    private TextField maxConcurrentTasks;
    ...
    @FXML
    public void comboBoxOnAction(ActionEvent event) throws IOException {
